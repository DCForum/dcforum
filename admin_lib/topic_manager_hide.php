...
function topic_manager_hide() {
   ...
   if ($in['ssaz'] == 'doit') {
      ...
      print "<tr class=\"dclite\"><td 
              class=\"dclite\">The topics you selected have been hidden.\n";
      print "</td></tr>\n";
      end_table();
   ...
   elseif ($in['ssaz'] == 'list') {
      ...
      elseif ($start_time > $stop_time) {
         ...
         $in['desc'] = "Following is a list of topics that are currently
                     ...
                     topics you wish to hide and then submit this form.";
