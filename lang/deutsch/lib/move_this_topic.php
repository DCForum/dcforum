...
$in['lang']['e_move_desc_1'] = "Du hast als Ziel eine Forengruppe gewählt. Es ist nicht möglich, 
                           ein Thema in eine Forengruppe zu verschieben. Bitte wähle ein anderes Forum als Ziel.";

$in['lang']['e_move_desc_2'] = "Du hast das selbe Forum als Ziel gewählt. Es ist nicht möglich,
                           ein Thema in das selbe Forum zu verschieben. Bitte wähle ein anderes Forum als Ziel.";

$in['lang']['page_header'] = "Thema verschieben";
$in['lang']['ok_mesg'] = "Das von dir gewählte Thema wurde verschoben.";
