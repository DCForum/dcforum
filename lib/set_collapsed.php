...
//
//
// 	$Id: set_collapsed.php,v 1.1 2003/04/14 09:33:44 david Exp $	
//
////////////////////////////////////////////////////////////////////////
function set_collapsed() {
   ...
   $temp_arr = explode('|',$in[DC_COOKIE][DC_EXPANDED_TOPICS]);
   ...
   $in[DC_COOKIE][DC_EXPANDED_TOPICS] = implode('|',$expanded_arr);
