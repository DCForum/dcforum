...
function user_manager_remove() {
   ...
   if ($in['ssaz'] == 'remove'
	   ...
	   if (! is_perm_account($u_id)) {
         ...
         print "<p>User accounts were successfully removed.  A total of
                $num_accounts were removed.</p>";
   }
   elseif ($in['ssaz'] == 'select_user') {

      print "<p>Select user accounts you wish to 
         remove and submit this form.<br />
         Please note that you cannot delete <strong>root</strong> 
         and <strong>guest</strong> accounts.</p>";
      ...
      print<<<END
         <p>
         Search the user database to find the user accounts you wish to remove
