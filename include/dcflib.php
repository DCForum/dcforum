...
function create_message_table($forum_id)
{
    ...
    $sql = "CREATE TABLE IF NOT EXISTS $mesg_table  (
           ...
           top_id          INT UNSIGNED NULL DEFAULT 0,
           ...
           topic_queue     ENUM('on','off') NULL DEFAULT 'off',
           topic_hidden    ENUM('on','off') NULL DEFAULT 'off',
           topic_pin       ENUM('0','1') NULL DEFAULT '0',
           disable_smilies ENUM('0','1') NULL DEFAULT '0',
           use_signature   ENUM('0','1') NULL DEFAULT '1',
           opt_1           ENUM('0','1') NULL DEFAULT '0',
           opt_2           ENUM('0','1') NULL DEFAULT '0',
...
function check_task($task)
{
    ...
    } else if (SETUP_AUTO_SEND_SUBSCRIPTION == '3') {
