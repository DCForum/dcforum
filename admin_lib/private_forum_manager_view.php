...
///////////////////////////////////////////////////////////////
//
// private_forum_manager_view.php
//
...
//
//
// 	$Id: private_forum_manager_view.php,v 1.1 2003/04/14 08:51:44 david Exp $	
//
///////////////////////////////////////////////////////////////
function private_forum_manager_view() {
   ...
   if ($in['ssaz'] == 'update') {
      ...
      // remove all entries for selected forums
      // Only remove from forums that this moderator owns
     if ($in['user_info']['g_id'] == 99) {
         $q = "DELETE FROM " . DB_PRIVATE_FORUM_LIST;
         db_query($q);
     }
     else {
       // get forums this moderator owns
       $q = "SELECT forum_id
               FROM " . DB_MODERATOR . "
