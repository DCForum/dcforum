...
//
//
// 	$Id: topic_subscribe.php,v 1.1 2003/04/14 09:33:28 david Exp $	
//
...
function topic_subscribe() {
   ...
   select_language("/lib/topic_subscribe.php");
   ...
   if (is_subscribed($in['forum'],$in['user_info']['id'],$in['topic_id'])) {
      ...
      print_alert_page($in['lang']['already_subscribed'],$in['lang']['already_subscribed_mesg']);
